...
class StreakFormatterTest {
    ...
    @Test
    fun `under 1 hour returns 0 hour streak`() {
        val start = instantAtStartOfDay(LocalDate.of(2026, 1, 1))
        val now = start.plusSeconds(59 * 60 + 59)
        assertThat(formatStreakDuration(start, now, 1)).isEqualTo("0 hour streak (1)")
    }
    ...
    fun `exactly 1 hour returns 1 hour streak`() {
        ...
        assertThat(formatStreakDuration(start, now, 1)).isEqualTo("1 hour streak (1)")
    }
    ...
    fun `23 hours 59 minutes returns 23 hour streak`() {
        ...
        assertThat(formatStreakDuration(start, now, 5)).isEqualTo("23 hour streak (5)")
    }
    ...
    fun `exactly 24 hours returns 1 day streak`() {
        ...
        assertThat(formatStreakDuration(start, now, 2)).isEqualTo("1 day streak (2)")
    }
    ...
    fun `59 days returns 59 day streak`() {
        ...
        assertThat(formatStreakDuration(start, end, 59))
            .isEqualTo("59 day streak (59)")
    }
    ...
    fun `60 days returns 2 month streak`() {
        ...
        assertThat(formatStreakDuration(start, end, 60))
            .isEqualTo("2 month streak (60)")
    }
    ...
    fun `89 days with 2 calendar months shows 2 month streak`() {
        ...
        assertThat(formatStreakDuration(start, end, 89))
            .isEqualTo("2 month streak (89)")
    }
    ...
    fun `11 months 29 days returns 11 month streak`() {
        ...
        assertThat(formatStreakDuration(start, end, 360))
            .isEqualTo("11 month streak (360)")
    }
    ...
    fun `exactly 12 months returns 1 year streak`() {
        ...
        assertThat(formatStreakDuration(start, end, 365))
            .isEqualTo("1 year streak (365)")
    }
    ...
    fun `4 years 3 months returns 4 year streak`() {
        ...
        assertThat(formatStreakDuration(start, end, 1500))
            .isEqualTo("4 year streak (1500)")
    }

    @Test
    fun `lapse formatter uses lapse noun and same thresholds`() {
        val start = instantAtStartOfDay(LocalDate.of(2026, 1, 1))
        assertThat(formatLapseDuration(start, start.plusSeconds(30 * 60), 1))
            .isEqualTo("0 hour lapse (1)")
        assertThat(formatLapseDuration(start, start.plusSeconds(3600), 1))
            .isEqualTo("1 hour lapse (1)")
        assertThat(formatLapseDuration(start, start.plusSeconds(3 * 3600), 2))
            .isEqualTo("3 hour lapse (2)")
        assertThat(formatLapseDuration(start, start.plusSeconds(3 * 86400), 4))
            .isEqualTo("3 day lapse (4)")
    }
}
